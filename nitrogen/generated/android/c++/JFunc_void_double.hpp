...
namespace margelo::nitro::backgroundfilter {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/backgroundfilter/Func_void_double;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/backgroundfilter/Func_void_double_cxx;";
